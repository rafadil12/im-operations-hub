      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex flex-wrap items-end gap-2">
          ...
          >
            ...
            <option value="Indonesia-L1-MES-Group">
              Indonesia-L1-MES-Group
            </option>

            <option value="Indonesia-L1-Desktop-Group">
              Indonesia-L1-Desktop-Group
            </option>

            <option value="Indonesia-L1-Data Center-Group">
              Indonesia-L1-Data Center-Group
            </option>

            <option value="Indonesia-L1-Network-Group">
              Indonesia-L1-Network-Group
            </option>

            <option value="Indonesia-L1-SAP-Group">
              Indonesia-L1-SAP-Group
            </option>

            <option value="Indonesia-L1-Application-Group">
              Indonesia-L1-Application-Group
            </option>
          </select>
