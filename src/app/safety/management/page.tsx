...
const WEEKLY_ACTIVITIES: ActivityConfig[] = [
  ...
  },
  {
    ...
    shortTitle: "Rapat HSE",
    description: "Rapat rutin HSE setiap hari Selasa.",
  ...
  },
  {
    ...
    title: "Pengamatan perilaku BBS",
    shortTitle: "BBS",
    description: "Pengamatan perilaku BBS satu kali setiap minggu dengan dokumentasi foto dan video.",
    requirement: "1x / minggu",
    frequency: "Mingguan",
    icon: "👀",
    uploadKind: "image-video",
