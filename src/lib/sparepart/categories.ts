...
export const SPAREPART_CATEGORY_CODES: SparepartCategoryCode[] = ["IT", "AGV", "ASSEMBLY", "MES"];
...
export function normalizeCategoryCode(value: string): SparepartCategoryCode | null {
...
export function groupByCanonicalCategory<T extends { code: string }>(rows: T[]): Map<string, T[]> {
