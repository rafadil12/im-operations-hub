const en = {
  ...
  nav: {
    ...
    safety: "Safety",
    sparepart: "Sparepart",
    sparepartManagement: "Operations",
    sparepartStock: "Stock",
    sparepartMaterialMovement: "Movements",
    sparepartPost: "Posting",
    sparepartDocuments: "Documents",
    sparepartMovementHistory: "History",
    sparepartMaterials: "Items",
    sparepartLocations: "Locations",
  ...
  sparepart: {
    ...
    movementHistoryDesc: "Line-level goods movements — filter by material, type, location, or date",
    movementHistorySearchHint: "Search by document number, material code, or note",
    ...
    formInventory: "Inventory Settings",
    formAdditional: "Additional Information",
    formCreateMaterial: "Create a new material master record",
    codeAutoHint: "Generated automatically from category.",
    labelEnglish: "English",
    labelChinese: "中文",
    masterCode: "Code",
    categoryCodePlaceholder: "e.g. IT, AGV, MES (max 3 letters)",
    categoryCodeHint: "Material codes will use this prefix + sequence (e.g. IT00001).",
    categoryNameEnPlaceholder: "e.g. Electronics, Assembly",
    categoryNameCnPlaceholder: "e.g. 电子, 流水线",
    categoryCodeInvalid: "Category code must be 1–3 letters (A–Z).",
    uomCodePlaceholder: "e.g. PCS, SET, BOX (max 4)",
    uomNameEnPlaceholder: "e.g. Pieces",
    uomNameCnPlaceholder: "e.g. 件",
    uomCodeInvalid: "UoM code must be 1–4 letters/numbers.",
    nameCnMustBeChinese: "Chinese description must include Chinese characters.",
  ...
  itsm: {
    ...
    monitoringRecent: "Monitoring recent tickets",
    monitoringOldest: "Monitoring longest-pending tickets",
 ...
 attendanceOverview: {
  ...
  share: "Share",
  topShare: "Top: {n}%",
  rankedByTicketVolume: "Ranked by ticket volume",
  more: "+{n} more",
  technicianWorkloadMix: "Technician workload & request type mix",
  technicians: "Technicians",
  techniciansByVolume: "Technicians by Incident / Request volume",
  incident: "Incident",
  request: "Request",
  serviceIncidentDistribution: "Service / Incident distribution",
  noData: "No data",
  currentPeriod: "Current Period",
  previousPeriod: "Previous Period",
  lastWeek: "Last Week",
  change: "Change",
  peak: "Peak",
  increased: "Increase vs Previous",
  decreased: "Decrease vs Previous",
  noChange: "No Change",
   topShareLabel: "Top Share",
  ofShown: "of shown",
  lead: "Lead",
  vsSecond: "vs #2",
  vsAverage: "{n}% vs avg",
  ...
  tickets: "tickets",
  highest: "Highest",
  percentOfShown: "{n}% of shown",
  topAboveMedian: "Top is above median",
  ...
  technicianPeriodComparison: "Technician performance vs previous period",
  ...
  requestType: "Request Type",
  ofTotal: "of Total",
  workloadVsQuality: "Workload vs. Quality",
  technicianWorkload: "Technician Workload",
  ticketHandledByTechnician: "Tickets handled by technician",
  quality: "Quality",
  workload: "Workload",
  technician: "Technician",
  noTechnicianData: "No technician data",
