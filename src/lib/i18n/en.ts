const en = {
  ...
  sparepart: {
    ...
    stockDesc: "Current stock by material — stock changes only via goods movements",
    postTitle: "Post Goods Movement",
    postDesc: "Post Goods Receipt (101) or Goods Issue / consumption (201)",
    documentsTitle: "Material Documents",
    documentsDesc: "History of posted goods movements",
    materialsTitle: "Material Master",
    materialsDesc: "Maintain material master data (code, name, brand, location)",
    code: "Material",
    name: "Description",
    brand: "Brand",
    model: "Model",
    ...
    importHint:
      "Upload Excel (.xlsx) with Kode Barang and Nama Barang. Stock quantities create a Goods Receipt (101) document.",
  },
  settings: {
    rolesTitle: "Roles",
