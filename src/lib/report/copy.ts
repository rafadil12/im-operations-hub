...
const REPORT_TEXT = {
  ...
  viewReport: ["View Week Report", "查看周报"] as TextPair,
  edit: ["Edit", "编辑"] as TextPair,
  view: ["View", "查看"] as TextPair,
  noReport: ["No Report", "无周报"] as TextPair,
  allWeeks: ["All Weeks", "全部周次"] as TextPair,
  today: ["Today", "今天"] as TextPair,
  ...
  oneReportRule: [
    "Each week can have only one report for this area. You can add a new report only for weeks that have no report.",
    "每个类别每周仅可有一份周报。仅无周报的周次可以新增。",
  ] as TextPair,
  reportAlreadyExists: [
    "A weekly report already exists for this year, area, and week. Use Edit instead.",
    "该年份、类别与周次已有周报，请使用编辑。",
  ] as TextPair,
  addReportSubtitle: [
  ...
  viewReportSubtitle: [
    "Review the weekly progress details below.",
    "查看以下本周进展详情。",
  ] as TextPair,
