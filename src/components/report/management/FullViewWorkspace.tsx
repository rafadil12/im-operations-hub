...
export function FullViewWorkspace({
  ...
  return (
    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-3 pb-5 pt-3 sm:px-5">{children}</div>

      {footer ? (
        <div className="flex shrink-0 flex-wrap justify-end gap-2 border-t border-border-subtle px-3 py-3 sm:px-5">
          {footer}
        </div>
      ) : null}
    </div>
