...
const reportTh =
  "sticky top-0 z-20 border-b border-border-subtle bg-bg/40 px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wide text-text-dim";
const reportTd = "border-b border-border-subtle px-3 py-3 align-middle text-sm";
const stickyTh =
  "sticky top-0 right-0 z-30 min-w-[8.5rem] border-b border-border-subtle bg-bg/40 px-3 py-2.5 text-center text-[10px] font-semibold uppercase tracking-wide text-text-dim shadow-[-8px_0_12px_-8px_var(--shadow-color-soft)]";
const stickyTd =
