...
- Materials import/template is master data only (Code, Name EN/CN, Brand EN/CN, Model, Notes) — no opening stock or location. Stock changes go through goods movements (101/201/311).
